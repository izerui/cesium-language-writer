...
public class AlignedAxisCesiumWriter extends CesiumInterpolatablePropertyWriter<AlignedAxisCesiumWriter> {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Cartesian> createCartesianAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<AlignedAxisCesiumWriter, Cartesian>(this,
				new CesiumWriterAdaptorWriteCallback<AlignedAxisCesiumWriter, Cartesian>() {
					public void invoke(AlignedAxisCesiumWriter me, Cartesian value) {
						me.writeCartesian(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<AlignedAxisCesiumWriter, Cartesian>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<AlignedAxisCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<AlignedAxisCesiumWriter, Reference>() {
