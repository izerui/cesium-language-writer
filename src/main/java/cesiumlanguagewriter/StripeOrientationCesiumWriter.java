...
public class StripeOrientationCesiumWriter extends CesiumPropertyWriter<StripeOrientationCesiumWriter> {
	...
	public StripeOrientationCesiumWriter(String propertyName) {
		super(propertyName);
		m_asStripeOrientation = new Lazy<ICesiumValuePropertyWriter<CesiumStripeOrientation>>(
				new Func1<ICesiumValuePropertyWriter<CesiumStripeOrientation>>(this, "createStripeOrientationAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<CesiumStripeOrientation> invoke() {
	...
	final private ICesiumValuePropertyWriter<CesiumStripeOrientation> createStripeOrientationAdaptor() {
		return new CesiumWriterAdaptor<StripeOrientationCesiumWriter, CesiumStripeOrientation>(this,
				new CesiumWriterAdaptorWriteCallback<StripeOrientationCesiumWriter, CesiumStripeOrientation>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<StripeOrientationCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<StripeOrientationCesiumWriter, Reference>() {
