...
public class LineThicknessCesiumWriter extends CesiumInterpolatablePropertyWriter<LineThicknessCesiumWriter> {
	...
	public LineThicknessCesiumWriter(String propertyName) {
		super(propertyName);
		m_asCartesian2 = new Lazy<ICesiumInterpolatableValuePropertyWriter<Rectangular>>(
				new Func1<ICesiumInterpolatableValuePropertyWriter<Rectangular>>(this, "createCartesian2Adaptor", new Class[] {}) {
					public ICesiumInterpolatableValuePropertyWriter<Rectangular> invoke() {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Rectangular> createCartesian2Adaptor() {
		return new CesiumInterpolatableWriterAdaptor<LineThicknessCesiumWriter, Rectangular>(this,
				new CesiumWriterAdaptorWriteCallback<LineThicknessCesiumWriter, Rectangular>() {
					public void invoke(LineThicknessCesiumWriter me, Rectangular value) {
						me.writeCartesian2(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<LineThicknessCesiumWriter, Rectangular>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<LineThicknessCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<LineThicknessCesiumWriter, Reference>() {
