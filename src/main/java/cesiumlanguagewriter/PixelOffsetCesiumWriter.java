...
public class PixelOffsetCesiumWriter extends CesiumInterpolatablePropertyWriter<PixelOffsetCesiumWriter> {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Rectangular> createCartesian2Adaptor() {
		return new CesiumInterpolatableWriterAdaptor<PixelOffsetCesiumWriter, Rectangular>(this,
				new CesiumWriterAdaptorWriteCallback<PixelOffsetCesiumWriter, Rectangular>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<PixelOffsetCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<PixelOffsetCesiumWriter, Reference>() {
