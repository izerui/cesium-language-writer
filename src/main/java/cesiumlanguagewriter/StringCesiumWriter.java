...
public class StringCesiumWriter extends CesiumPropertyWriter<StringCesiumWriter> {
	...
	public StringCesiumWriter(String propertyName) {
		super(propertyName);
		m_asString = new Lazy<ICesiumValuePropertyWriter<String>>(new Func1<ICesiumValuePropertyWriter<String>>(this,
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<StringCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<StringCesiumWriter, Reference>() {
