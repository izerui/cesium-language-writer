...
public class VerticalOriginCesiumWriter extends CesiumPropertyWriter<VerticalOriginCesiumWriter> {
	...
	public VerticalOriginCesiumWriter(String propertyName) {
		super(propertyName);
		m_asVerticalOrigin = new Lazy<ICesiumValuePropertyWriter<CesiumVerticalOrigin>>(
				new Func1<ICesiumValuePropertyWriter<CesiumVerticalOrigin>>(this, "createVerticalOriginAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<CesiumVerticalOrigin> invoke() {
	...
	final private ICesiumValuePropertyWriter<CesiumVerticalOrigin> createVerticalOriginAdaptor() {
		return new CesiumWriterAdaptor<VerticalOriginCesiumWriter, CesiumVerticalOrigin>(this,
				new CesiumWriterAdaptorWriteCallback<VerticalOriginCesiumWriter, CesiumVerticalOrigin>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<VerticalOriginCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<VerticalOriginCesiumWriter, Reference>() {
