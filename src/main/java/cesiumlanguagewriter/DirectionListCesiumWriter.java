...
public class DirectionListCesiumWriter extends CesiumPropertyWriter<DirectionListCesiumWriter> {
	...
	public DirectionListCesiumWriter(String propertyName) {
		super(propertyName);
		m_asSpherical = new Lazy<ICesiumValuePropertyWriter<Iterable<Spherical>>>(
				new Func1<ICesiumValuePropertyWriter<Iterable<Spherical>>>(this, "createSphericalAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<Iterable<Spherical>> invoke() {
						return createSphericalAdaptor();
					}
				}, false);
		m_asUnitSpherical = new Lazy<ICesiumValuePropertyWriter<Iterable<UnitSpherical>>>(
				new Func1<ICesiumValuePropertyWriter<Iterable<UnitSpherical>>>(this, "createUnitSphericalAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<Iterable<UnitSpherical>> invoke() {
						return createUnitSphericalAdaptor();
					}
				}, false);
		m_asCartesian = new Lazy<ICesiumValuePropertyWriter<Iterable<Cartesian>>>(
				new Func1<ICesiumValuePropertyWriter<Iterable<Cartesian>>>(this, "createCartesianAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<Iterable<Cartesian>> invoke() {
						return createCartesianAdaptor();
					}
				}, false);
		m_asUnitCartesian = new Lazy<ICesiumValuePropertyWriter<Iterable<UnitCartesian>>>(
				new Func1<ICesiumValuePropertyWriter<Iterable<UnitCartesian>>>(this, "createUnitCartesianAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<Iterable<UnitCartesian>> invoke() {
	...
	final private ICesiumValuePropertyWriter<Iterable<Spherical>> createSphericalAdaptor() {
		return new CesiumWriterAdaptor<DirectionListCesiumWriter, Iterable<Spherical>>(this,
				new CesiumWriterAdaptorWriteCallback<DirectionListCesiumWriter, Iterable<Spherical>>() {
	...
	final private ICesiumValuePropertyWriter<Iterable<UnitSpherical>> createUnitSphericalAdaptor() {
		return new CesiumWriterAdaptor<DirectionListCesiumWriter, Iterable<UnitSpherical>>(this,
				new CesiumWriterAdaptorWriteCallback<DirectionListCesiumWriter, Iterable<UnitSpherical>>() {
	...
	final private ICesiumValuePropertyWriter<Iterable<Cartesian>> createCartesianAdaptor() {
		return new CesiumWriterAdaptor<DirectionListCesiumWriter, Iterable<Cartesian>>(this,
				new CesiumWriterAdaptorWriteCallback<DirectionListCesiumWriter, Iterable<Cartesian>>() {
	...
	final private ICesiumValuePropertyWriter<Iterable<UnitCartesian>> createUnitCartesianAdaptor() {
		return new CesiumWriterAdaptor<DirectionListCesiumWriter, Iterable<UnitCartesian>>(this,
				new CesiumWriterAdaptorWriteCallback<DirectionListCesiumWriter, Iterable<UnitCartesian>>() {
