...
public class TranslationCesiumWriter extends CesiumInterpolatablePropertyWriter<TranslationCesiumWriter> {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Cartesian> createCartesianAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<TranslationCesiumWriter, Cartesian>(this,
				new CesiumWriterAdaptorWriteCallback<TranslationCesiumWriter, Cartesian>() {
					public void invoke(TranslationCesiumWriter me, Cartesian value) {
						me.writeCartesian(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<TranslationCesiumWriter, Cartesian>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<TranslationCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<TranslationCesiumWriter, Reference>() {
