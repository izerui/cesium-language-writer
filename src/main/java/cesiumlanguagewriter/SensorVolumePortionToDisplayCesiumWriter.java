...
public class SensorVolumePortionToDisplayCesiumWriter extends CesiumPropertyWriter<SensorVolumePortionToDisplayCesiumWriter> {
	...
	public SensorVolumePortionToDisplayCesiumWriter(String propertyName) {
		super(propertyName);
		m_asPortionToDisplay = new Lazy<ICesiumValuePropertyWriter<CesiumSensorVolumePortionToDisplay>>(
				new Func1<ICesiumValuePropertyWriter<CesiumSensorVolumePortionToDisplay>>(this, "createPortionToDisplayAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<CesiumSensorVolumePortionToDisplay> invoke() {
	...
	final private ICesiumValuePropertyWriter<CesiumSensorVolumePortionToDisplay> createPortionToDisplayAdaptor() {
		return new CesiumWriterAdaptor<SensorVolumePortionToDisplayCesiumWriter, CesiumSensorVolumePortionToDisplay>(this,
				new CesiumWriterAdaptorWriteCallback<SensorVolumePortionToDisplayCesiumWriter, CesiumSensorVolumePortionToDisplay>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<SensorVolumePortionToDisplayCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<SensorVolumePortionToDisplayCesiumWriter, Reference>() {
