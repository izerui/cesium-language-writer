...
public class ScaleCesiumWriter extends CesiumInterpolatablePropertyWriter<ScaleCesiumWriter> {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Cartesian> createCartesianAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<ScaleCesiumWriter, Cartesian>(this,
				new CesiumWriterAdaptorWriteCallback<ScaleCesiumWriter, Cartesian>() {
					public void invoke(ScaleCesiumWriter me, Cartesian value) {
						me.writeCartesian(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<ScaleCesiumWriter, Cartesian>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<ScaleCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<ScaleCesiumWriter, Reference>() {
