...
public class FontCesiumWriter extends CesiumPropertyWriter<FontCesiumWriter> {
	...
	public FontCesiumWriter(String propertyName) {
		super(propertyName);
		m_asFont = new Lazy<ICesiumValuePropertyWriter<String>>(new Func1<ICesiumValuePropertyWriter<String>>(this, "createFontAdaptor",
				new Class[] {}) {
			public ICesiumValuePropertyWriter<String> invoke() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<FontCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<FontCesiumWriter, Reference>() {
