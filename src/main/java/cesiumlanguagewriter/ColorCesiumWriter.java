...
public class ColorCesiumWriter extends CesiumInterpolatablePropertyWriter<ColorCesiumWriter> {
	...
	public ColorCesiumWriter(String propertyName) {
		super(propertyName);
		m_asRgba = new Lazy<ICesiumInterpolatableValuePropertyWriter<Color>>(new Func1<ICesiumInterpolatableValuePropertyWriter<Color>>(
				this, "createRgbaAdaptor", new Class[] {}) {
			public ICesiumInterpolatableValuePropertyWriter<Color> invoke() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<ColorCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<ColorCesiumWriter, Reference>() {
