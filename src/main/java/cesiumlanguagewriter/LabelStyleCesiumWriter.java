...
public class LabelStyleCesiumWriter extends CesiumPropertyWriter<LabelStyleCesiumWriter> {
	...
	public LabelStyleCesiumWriter(String propertyName) {
		super(propertyName);
		m_asLabelStyle = new Lazy<ICesiumValuePropertyWriter<CesiumLabelStyle>>(new Func1<ICesiumValuePropertyWriter<CesiumLabelStyle>>(
				this, "createLabelStyleAdaptor", new Class[] {}) {
			public ICesiumValuePropertyWriter<CesiumLabelStyle> invoke() {
	...
	final private ICesiumValuePropertyWriter<CesiumLabelStyle> createLabelStyleAdaptor() {
		return new CesiumWriterAdaptor<LabelStyleCesiumWriter, CesiumLabelStyle>(this,
				new CesiumWriterAdaptorWriteCallback<LabelStyleCesiumWriter, CesiumLabelStyle>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<LabelStyleCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<LabelStyleCesiumWriter, Reference>() {
