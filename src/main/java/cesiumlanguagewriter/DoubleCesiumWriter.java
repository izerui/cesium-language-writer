...
public class DoubleCesiumWriter extends CesiumInterpolatablePropertyWriter<DoubleCesiumWriter> {
	...
	public DoubleCesiumWriter(String propertyName) {
		super(propertyName);
		m_asNumber = new Lazy<ICesiumInterpolatableValuePropertyWriter<Double>>(
				new Func1<ICesiumInterpolatableValuePropertyWriter<Double>>(this, "createNumberAdaptor", new Class[] {}) {
					public ICesiumInterpolatableValuePropertyWriter<Double> invoke() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<DoubleCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<DoubleCesiumWriter, Reference>() {
