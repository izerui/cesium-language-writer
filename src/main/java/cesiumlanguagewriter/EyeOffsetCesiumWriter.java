...
public class EyeOffsetCesiumWriter extends CesiumInterpolatablePropertyWriter<EyeOffsetCesiumWriter> {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Cartesian> createCartesianAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<EyeOffsetCesiumWriter, Cartesian>(this,
				new CesiumWriterAdaptorWriteCallback<EyeOffsetCesiumWriter, Cartesian>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<EyeOffsetCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<EyeOffsetCesiumWriter, Reference>() {
