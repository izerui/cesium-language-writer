...
public class PositionListCesiumWriter extends CesiumPropertyWriter<PositionListCesiumWriter> {
	...
	public PositionListCesiumWriter(String propertyName) {
		...
		m_asCartographicRadians = new Lazy<ICesiumValuePropertyWriter<Iterable<Cartographic>>>(
				new Func1<ICesiumValuePropertyWriter<Iterable<Cartographic>>>(this, "createCartographicRadiansAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<Iterable<Cartographic>> invoke() {
						return createCartographicRadiansAdaptor();
					}
				}, false);
		m_asCartographicDegrees = new Lazy<ICesiumValuePropertyWriter<Iterable<Cartographic>>>(
				new Func1<ICesiumValuePropertyWriter<Iterable<Cartographic>>>(this, "createCartographicDegreesAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<Iterable<Cartographic>> invoke() {
						return createCartographicDegreesAdaptor();
					}
				}, false);
		m_asReferences = new Lazy<ICesiumValuePropertyWriter<Iterable<Reference>>>(
				new Func1<ICesiumValuePropertyWriter<Iterable<Reference>>>(this, "createReferencesAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<Iterable<Reference>> invoke() {
	...
	final private ICesiumValuePropertyWriter<Iterable<Cartesian>> createCartesianAdaptor() {
		return new CesiumWriterAdaptor<PositionListCesiumWriter, Iterable<Cartesian>>(this,
				new CesiumWriterAdaptorWriteCallback<PositionListCesiumWriter, Iterable<Cartesian>>() {
	...
	final private ICesiumValuePropertyWriter<Iterable<Cartographic>> createCartographicRadiansAdaptor() {
		return new CesiumWriterAdaptor<PositionListCesiumWriter, Iterable<Cartographic>>(this,
				new CesiumWriterAdaptorWriteCallback<PositionListCesiumWriter, Iterable<Cartographic>>() {
	...
	final private ICesiumValuePropertyWriter<Iterable<Reference>> createReferencesAdaptor() {
		return new CesiumWriterAdaptor<PositionListCesiumWriter, Iterable<Reference>>(this,
				new CesiumWriterAdaptorWriteCallback<PositionListCesiumWriter, Iterable<Reference>>() {
