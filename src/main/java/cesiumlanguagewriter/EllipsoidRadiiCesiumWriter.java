...
public class EllipsoidRadiiCesiumWriter extends CesiumInterpolatablePropertyWriter<EllipsoidRadiiCesiumWriter> {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Cartesian> createCartesianAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<EllipsoidRadiiCesiumWriter, Cartesian>(this,
				new CesiumWriterAdaptorWriteCallback<EllipsoidRadiiCesiumWriter, Cartesian>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<EllipsoidRadiiCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<EllipsoidRadiiCesiumWriter, Reference>() {
