...
public class PositionCesiumWriter extends CesiumInterpolatablePropertyWriter<PositionCesiumWriter> {
	...
	public PositionCesiumWriter(String propertyName) {
		...
		m_asCartographicRadians = new Lazy<ICesiumInterpolatableValuePropertyWriter<Cartographic>>(
				new Func1<ICesiumInterpolatableValuePropertyWriter<Cartographic>>(this, "createCartographicRadiansAdaptor", new Class[] {}) {
					public ICesiumInterpolatableValuePropertyWriter<Cartographic> invoke() {
						return createCartographicRadiansAdaptor();
					}
				}, false);
		m_asCartographicDegrees = new Lazy<ICesiumInterpolatableValuePropertyWriter<Cartographic>>(
				new Func1<ICesiumInterpolatableValuePropertyWriter<Cartographic>>(this, "createCartographicDegreesAdaptor", new Class[] {}) {
					public ICesiumInterpolatableValuePropertyWriter<Cartographic> invoke() {
						return createCartographicDegreesAdaptor();
					}
				}, false);
		m_asCartesianVelocity = new Lazy<ICesiumInterpolatableValuePropertyWriter<Motion1<Cartesian>>>(
				new Func1<ICesiumInterpolatableValuePropertyWriter<Motion1<Cartesian>>>(this, "createCartesianVelocityAdaptor", new Class[] {}) {
					public ICesiumInterpolatableValuePropertyWriter<Motion1<Cartesian>> invoke() {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Cartesian> createCartesianAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<PositionCesiumWriter, Cartesian>(this,
				new CesiumWriterAdaptorWriteCallback<PositionCesiumWriter, Cartesian>() {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Cartographic> createCartographicRadiansAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<PositionCesiumWriter, Cartographic>(this,
				new CesiumWriterAdaptorWriteCallback<PositionCesiumWriter, Cartographic>() {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Motion1<Cartesian>> createCartesianVelocityAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<PositionCesiumWriter, Motion1<Cartesian>>(this,
				new CesiumWriterAdaptorWriteCallback<PositionCesiumWriter, Motion1<Cartesian>>() {
					public void invoke(PositionCesiumWriter me, Motion1<Cartesian> value) {
						me.writeCartesianVelocity(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<PositionCesiumWriter, Motion1<Cartesian>>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<PositionCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<PositionCesiumWriter, Reference>() {
