...
public class UriCesiumWriter extends CesiumPropertyWriter<UriCesiumWriter> {
	...
	public UriCesiumWriter(String propertyName) {
		super(propertyName);
		m_asUri = new Lazy<ICesiumValuePropertyWriter<CesiumResource>>(new Func1<ICesiumValuePropertyWriter<CesiumResource>>(this,
				"createUriAdaptor", new Class[] {}) {
			public ICesiumValuePropertyWriter<CesiumResource> invoke() {
	...
	final private ICesiumValuePropertyWriter<CesiumResource> createUriAdaptor() {
		return new CesiumWriterAdaptor<UriCesiumWriter, CesiumResource>(this,
				new CesiumWriterAdaptorWriteCallback<UriCesiumWriter, CesiumResource>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<UriCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<UriCesiumWriter, Reference>() {
