...
public class RepeatCesiumWriter extends CesiumInterpolatablePropertyWriter<RepeatCesiumWriter> {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Rectangular> createCartesian2Adaptor() {
		return new CesiumInterpolatableWriterAdaptor<RepeatCesiumWriter, Rectangular>(this,
				new CesiumWriterAdaptorWriteCallback<RepeatCesiumWriter, Rectangular>() {
					public void invoke(RepeatCesiumWriter me, Rectangular value) {
						me.writeCartesian2(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<RepeatCesiumWriter, Rectangular>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<RepeatCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<RepeatCesiumWriter, Reference>() {
