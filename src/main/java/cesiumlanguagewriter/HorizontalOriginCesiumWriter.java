...
public class HorizontalOriginCesiumWriter extends CesiumPropertyWriter<HorizontalOriginCesiumWriter> {
	...
	public HorizontalOriginCesiumWriter(String propertyName) {
		super(propertyName);
		m_asHorizontalOrigin = new Lazy<ICesiumValuePropertyWriter<CesiumHorizontalOrigin>>(
				new Func1<ICesiumValuePropertyWriter<CesiumHorizontalOrigin>>(this, "createHorizontalOriginAdaptor", new Class[] {}) {
					public ICesiumValuePropertyWriter<CesiumHorizontalOrigin> invoke() {
	...
	final private ICesiumValuePropertyWriter<CesiumHorizontalOrigin> createHorizontalOriginAdaptor() {
		return new CesiumWriterAdaptor<HorizontalOriginCesiumWriter, CesiumHorizontalOrigin>(this,
				new CesiumWriterAdaptorWriteCallback<HorizontalOriginCesiumWriter, CesiumHorizontalOrigin>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<HorizontalOriginCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<HorizontalOriginCesiumWriter, Reference>() {
