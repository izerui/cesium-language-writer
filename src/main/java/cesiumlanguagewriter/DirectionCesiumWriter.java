...
public class DirectionCesiumWriter extends CesiumInterpolatablePropertyWriter<DirectionCesiumWriter> {
	...
	public DirectionCesiumWriter(String propertyName) {
		super(propertyName);
		m_asSpherical = new Lazy<ICesiumInterpolatableValuePropertyWriter<Spherical>>(
				new Func1<ICesiumInterpolatableValuePropertyWriter<Spherical>>(this, "createSphericalAdaptor", new Class[] {}) {
					public ICesiumInterpolatableValuePropertyWriter<Spherical> invoke() {
						return createSphericalAdaptor();
					}
				}, false);
		m_asUnitSpherical = new Lazy<ICesiumInterpolatableValuePropertyWriter<UnitSpherical>>(
				new Func1<ICesiumInterpolatableValuePropertyWriter<UnitSpherical>>(this, "createUnitSphericalAdaptor", new Class[] {}) {
					public ICesiumInterpolatableValuePropertyWriter<UnitSpherical> invoke() {
						return createUnitSphericalAdaptor();
					}
				}, false);
		m_asCartesian = new Lazy<ICesiumInterpolatableValuePropertyWriter<Cartesian>>(
				new Func1<ICesiumInterpolatableValuePropertyWriter<Cartesian>>(this, "createCartesianAdaptor", new Class[] {}) {
					public ICesiumInterpolatableValuePropertyWriter<Cartesian> invoke() {
						return createCartesianAdaptor();
					}
				}, false);
		m_asUnitCartesian = new Lazy<ICesiumInterpolatableValuePropertyWriter<UnitCartesian>>(
				new Func1<ICesiumInterpolatableValuePropertyWriter<UnitCartesian>>(this, "createUnitCartesianAdaptor", new Class[] {}) {
					public ICesiumInterpolatableValuePropertyWriter<UnitCartesian> invoke() {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Spherical> createSphericalAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<DirectionCesiumWriter, Spherical>(this,
				new CesiumWriterAdaptorWriteCallback<DirectionCesiumWriter, Spherical>() {
					public void invoke(DirectionCesiumWriter me, Spherical value) {
						me.writeSpherical(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<DirectionCesiumWriter, Spherical>() {
	...
	final private ICesiumInterpolatableValuePropertyWriter<UnitSpherical> createUnitSphericalAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<DirectionCesiumWriter, UnitSpherical>(this,
				new CesiumWriterAdaptorWriteCallback<DirectionCesiumWriter, UnitSpherical>() {
					public void invoke(DirectionCesiumWriter me, UnitSpherical value) {
						me.writeUnitSpherical(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<DirectionCesiumWriter, UnitSpherical>() {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Cartesian> createCartesianAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<DirectionCesiumWriter, Cartesian>(this,
				new CesiumWriterAdaptorWriteCallback<DirectionCesiumWriter, Cartesian>() {
					public void invoke(DirectionCesiumWriter me, Cartesian value) {
						me.writeCartesian(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<DirectionCesiumWriter, Cartesian>() {
	...
	final private ICesiumInterpolatableValuePropertyWriter<UnitCartesian> createUnitCartesianAdaptor() {
		return new CesiumInterpolatableWriterAdaptor<DirectionCesiumWriter, UnitCartesian>(this,
				new CesiumWriterAdaptorWriteCallback<DirectionCesiumWriter, UnitCartesian>() {
					public void invoke(DirectionCesiumWriter me, UnitCartesian value) {
						me.writeUnitCartesian(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<DirectionCesiumWriter, UnitCartesian>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<DirectionCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<DirectionCesiumWriter, Reference>() {
