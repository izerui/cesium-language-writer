...
public class LineOffsetCesiumWriter extends CesiumInterpolatablePropertyWriter<LineOffsetCesiumWriter> {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Rectangular> createCartesian2Adaptor() {
		return new CesiumInterpolatableWriterAdaptor<LineOffsetCesiumWriter, Rectangular>(this,
				new CesiumWriterAdaptorWriteCallback<LineOffsetCesiumWriter, Rectangular>() {
					public void invoke(LineOffsetCesiumWriter me, Rectangular value) {
						me.writeCartesian2(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<LineOffsetCesiumWriter, Rectangular>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<LineOffsetCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<LineOffsetCesiumWriter, Reference>() {
