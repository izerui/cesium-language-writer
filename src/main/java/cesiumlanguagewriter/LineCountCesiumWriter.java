...
public class LineCountCesiumWriter extends CesiumInterpolatablePropertyWriter<LineCountCesiumWriter> {
	...
	final private ICesiumInterpolatableValuePropertyWriter<Rectangular> createCartesian2Adaptor() {
		return new CesiumInterpolatableWriterAdaptor<LineCountCesiumWriter, Rectangular>(this,
				new CesiumWriterAdaptorWriteCallback<LineCountCesiumWriter, Rectangular>() {
					public void invoke(LineCountCesiumWriter me, Rectangular value) {
						me.writeCartesian2(value);
					}
				}, new CesiumWriterAdaptorWriteSamplesCallback<LineCountCesiumWriter, Rectangular>() {
	...
	final private ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
		return new CesiumWriterAdaptor<LineCountCesiumWriter, Reference>(this,
				new CesiumWriterAdaptorWriteCallback<LineCountCesiumWriter, Reference>() {
